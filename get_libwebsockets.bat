...
cmake -DCMAKE_BUILD_TYPE=Release -DLWS_WITH_SSL=OFF -DCMAKE_SYSTEM_VERSION=8.1 -S ./ -B ./build32
cd build32
cmake --build . --config Release

cd ..
md build64
cmake -DCMAKE_BUILD_TYPE=Release -DLWS_WITH_SSL=OFF -DCMAKE_GENERATOR_PLATFORM=x64 -DCMAKE_SYSTEM_VERSION=8.1 -S ./ -B ./build64
cd build64
cmake --build . --config Release
